...
-(void)autoRefresh {
    ...
    if(currentTab == 1 && settingsVisible == 0){
        NSLog(@"#*#*#*#*#*#* Screen 1 : Auto Refreshing UIWebView #*#*#*#*##*#*");
        [self loadURL];
    }
}
...
- (void)loadSettings {
    ...
    _Title = [defaults objectForKey:@"Tab1Title"];
    _URL = [defaults objectForKey:@"Tab1URL"];
    _User = [defaults objectForKey:@"Tab1User"];
    _Password = [defaults objectForKey:@"Tab1Password"];
    _RefreshInterval = [defaults integerForKey:@"Tab1RefreshInterval"];
    _LoadingStyle = [defaults integerForKey:@"Tab1LoadingStyle"];
